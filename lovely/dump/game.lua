LOVELY_INTEGRITY = '67c9c3dcc0dc480962c5a26d96cc02a76f3d246b164a5ded4092fcdc59f2c39a'
...
function Game:start_run(args)
            ...
            if _ch.rules then
                ...
                if _ch.rules.custom then
                    ...
                    if v.id == "mf_superboss_active" then
                      ...
                      G.GAME.no_superboss_reset = true
                    end
    ...
    G.hand_text_area = {
        ...
        op = self.HUD:get_UIE_by_ID('chipmult_op'),
    ...
    if saveTable then 
        ...
        Q(function() update_operator_display() return true end)
        for k, v in pairs(G.GAME.hands) do
