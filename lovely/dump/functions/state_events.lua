LOVELY_INTEGRITY = '65b79c7f81ff7d455c0eece4d059a6fefbd53e98b54bf7ee24385c1377808cf7'
...
G.FUNCS.draw_from_deck_to_hand = function(e)
    ...
    if G.STATE == G.STATES.DRAW_TO_HAND and (G.GAME.current_round.hands_played > 0 or
      ...
      for _, jkr in pairs(SMODS.find_card("j_mf_snake")) do
        snake_count = snake_count + jkr.ability.extra
      end
      if snake_count ~= 0 then
        hand_space = math.min(#G.deck.cards, snake_count)
      end
    end
